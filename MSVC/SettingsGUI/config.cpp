...
MyDialog2::MyDialog2( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText4->SetFont( wxFont( 20, wxFONTFAMILY_SWISS, wxFONTSTYLE_ITALIC, wxFONTWEIGHT_BOLD, false, wxT("Nice") ) );
	...
	m_staticVersion->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_SWISS, wxFONTSTYLE_ITALIC, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	m_RunButton->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	m_staticText6->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_SWISS, wxFONTSTYLE_ITALIC, wxFONTWEIGHT_NORMAL, false, wxEmptyString ) );
	...
	m_TestAccountButton = new wxButton( m_Basic, wxID_ANY, wxT("Sign In"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer481->Add( m_TestAccountButton, 0, wxALIGN_RIGHT|wxALL, 5 );
	...
	m_CreateAccountButton->SetFont( wxFont( 10, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxEmptyString ) );

	bSizer50->Add( m_CreateAccountButton, 0, wxALIGN_RIGHT|wxALL, 5 );

	sbSizer5->Add( bSizer50, 0, wxEXPAND, 5 );
	...
	m_Flock = new wxPanel( m_notebook2, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer52;
	bSizer52 = new wxBoxSizer( wxVERTICAL );

	wxStaticBoxSizer* sbSizer2;
	sbSizer2 = new wxStaticBoxSizer( new wxStaticBox( m_Flock, wxID_ANY, wxT("Local Flock") ), wxVERTICAL );

	wxBoxSizer* bSizer35;
	bSizer35 = new wxBoxSizer( wxVERTICAL );

	m_staticTextFlockSize = new wxStaticText( m_Flock, wxID_ANY, wxT("New sheep are created everyday.  When the screensaver runs,\nit tries to download them, and saves them on your hard disk,\ndeleting old ones to make room.  Login to get more sheep.\nIt is currently using 0 MBs"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText7 = new wxStaticText( m_Flock, wxID_ANY, wxT("Max disk space:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText10 = new wxStaticText( m_Flock, wxID_ANY, wxT("MB"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_checkUnlimitedCache = new wxCheckBox( m_Flock, wxID_ANY, wxT("No Maximum"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
	...
	bSizer52->Add( sbSizer2, 0, wxEXPAND, 5 );

	m_GoldFlockStaticSizer = new wxStaticBoxSizer( new wxStaticBox( m_Flock, wxID_ANY, wxT("Gold Flock") ), wxVERTICAL );
	...
	m_staticText20 = new wxStaticText( m_Flock, wxID_ANY, wxT("Max disk space:"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText21 = new wxStaticText( m_Flock, wxID_ANY, wxT("MB"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_checkGoldUnlimitedCache = new wxCheckBox( m_Flock, wxID_ANY, wxT("No Maximum"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
	...
	m_GoldFlockStaticSizer->Add( bSizer281, 1, wxALIGN_RIGHT|wxALL, 5 );

	bSizer52->Add( m_GoldFlockStaticSizer, 0, wxEXPAND, 5 );

	m_Flock->SetSizer( bSizer52 );
	m_Flock->Layout();
